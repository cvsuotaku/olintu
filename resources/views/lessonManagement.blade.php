                        ...
                        @foreach($lessons as $lesson) 
                            <tr class=" border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 inline-flex">
                                    ...
                                    {{-- <svg data-modal-target="delete-modal-{{$lesson->lessonId}}" data-modal-toggle="delete-modal-{{$student->STUDENT_ID}}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
